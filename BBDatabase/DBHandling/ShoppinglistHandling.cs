...
namespace BBCollection.DBHandling
{
    ...
    {
        public void AddList(string username, List<Shoppinglist> shoppinglists)
        {
            string addQuery =
        ...
        public List<Shoppinglist> GetList(string username)
        {
        ...
        public void Delete(string slName, string username)
        {
            string sLQuery =
